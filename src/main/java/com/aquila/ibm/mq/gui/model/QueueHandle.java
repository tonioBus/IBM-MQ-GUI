 ...
 *
 * Represents a handle (connection) to a queue.
 * Shows which process/application is using a queue, including
 * process ID, user ID, connection type, and open options.
 */
