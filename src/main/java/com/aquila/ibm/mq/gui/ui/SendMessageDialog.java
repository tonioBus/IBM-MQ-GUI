 ...
 *
 * SWT dialog for sending messages to queues.
 * Supports single and batch message sending, priority/persistence
 * configuration, template management, and progress tracking.
 */
